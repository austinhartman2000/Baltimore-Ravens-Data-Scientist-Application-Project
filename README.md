...
### Note on GPBoost
GPBoost may require additional setup on some systems. If you encounter issues installing GPBoost, refer to the [official installation guide](https://github.com/fabsig/GPBoost).
